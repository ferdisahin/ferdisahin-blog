...
export default function Page({page}){
    return (
        <>
            ...
            <div className="my-24">
                <h1 className="font-bold text-xl md:text-3xl">{page.title}</h1>
                <div className="text-content text-gray-500 mt-2 md:mt-5" dangerouslySetInnerHTML={{__html: page.content.html}} />
            </div>
